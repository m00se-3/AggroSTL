...
namespace aggro
{
    ...
    */
    ...
    /*
        This struct times a function. By comparing speed with the STL we can determine how well, or poorly, our code is optimized.
    */
    struct bench_timer
    {
        inline static std::chrono::high_resolution_clock::time_point time = std::chrono::high_resolution_clock::now();

        bench_timer() = default;
        ~bench_timer()
        {
            std::chrono::high_resolution_clock::time_point current = std::chrono::high_resolution_clock::now();
            std::cout << "Function finished in " << std::chrono::duration_cast<std::chrono::microseconds>(current - time)
            << " microseconds.\n";
...
func(aggro::bench_timer(), aggro::heap_counter());
